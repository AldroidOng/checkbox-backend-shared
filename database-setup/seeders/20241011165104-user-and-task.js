...
module.exports = {
  async up(queryInterface, Sequelize) {
      ...
      [
        {
          ...
          password: 'password1', // Use a hashed password in production
          name: 'User One',
        },
        {
          email: 'user2@example.com',
          password: 'password2', // Use a hashed password in production
          name: 'User Two',
        },
      ],
      { returning: true },
    ...
    // const userId1 = users[0].id; // Get the ID of the first user
    // const userId2 = users[1].id; // Get the ID of the second user
